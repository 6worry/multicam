...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-10">
				<form name="login_frm" action="/examservlet/mvc/login" method="post">
																		...
																		<tr>
																			<td>
																				<table cellpadding="0" cellspacing="0" border=0>
																					...
																					<tr>
																						<td colspan=3><img
																							src="/examservlet/images2/page_login.gif"></td>
																					</tr>
																					<tr>
																						<td height=25></td>
																					</tr>
																					<tr>
																						<td background="/examservlet/images2/inputBg.gif"><img
																							src="/examservlet/images2/login_id.gif"></td>
																						<td background="/examservlet/images2/inputBg.gif"><input
																							type="text" name="id" size="15" class="grayinput"
																							tabindex=1 style="width: 156;"
																							 value='<%= id %>'></td>
																						<td rowspan=3 style="padding-left: 10" valign=bottom>
																						<input
																							type='image' src="/examservlet/images2/btn_login.gif"
																					...
																					<tr>
																						<td background="/examservlet/images2/inputBg.gif"><img
																							src="/examservlet/images2/login_pass.gif"></td>
																						<td background="/examservlet/images2/inputBg.gif"><input
