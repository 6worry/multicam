...
<body>
			<div class="col-lg-10">
				<form name="login_frm" action="/examspring/login" method="post">
																		...
																		<tr>
																			<td>
																				<table cellpadding="0" cellspacing="0" border=0>
																					...
																					<tr>
																						<td colspan=3><img
																							src="/examspring/images/page_login.gif" alt="사진이양"></td>
																					</tr>
																					<tr>
																						<td height=25></td>
																					</tr>
																					<tr>
																						<td background="/examspring/images/inputBg.gif"><img
																							src="/examspring/images/login_id.gif" alt="사진이양"></td>
																						<td background="/examspring/images/inputBg.gif"><input
																							type="text" name="id" size="15" class="grayinput"
																							tabindex=1 style="width: 156;"
																							 value=""></td>
																						<td rowspan=3 style="padding-left: 10" valign=bottom>
																						<input
																							type='image' src="/examspring/images/btn_login.gif"
																							border="0" tabindex=3 alt="사진이양"></td>
																					</tr>
																					<tr>
																						<td height=10></td>
																					</tr>
																					<tr>
																						<td background="/examspring/images/inputBg.gif"><img
																							src="/examspring/images/login_pass.gif" alt="사진이양"></td>
																						<td background="/examspring/images/inputBg.gif"><input
