  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/examspring/tiles/insert"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        <li><a href="/examspring/tiles/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
    </div>
  </div>
</nav>
